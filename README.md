...
- 🎓 Computer Science undergraduate with a strong interest in software engineering
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      <h3>⚡ APiXY – API Testing Tool</h3>
      <p>A lightweight and modern API testing tool — a fast alternative to traditional clients for sending, inspecting, and debugging API requests.</p>
      <p>
        <b>Tech:</b> React • Vite • TailwindCSS
      </p>
      <p>
...
➡️ Explore more on my [**repositories page**](https://github.com/RISHAV-ANAND7?tab=repositories).
...
- 🔹 Cloud Computing & DevOps Fundamentals (AWS, Docker, CI/CD)
